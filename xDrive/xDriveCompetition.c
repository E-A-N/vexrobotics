...
#pragma config(Motor,  port1,           leftFrontDrive, tmotorVex393_HBridge, openLoop, reversed)
#pragma config(Motor,  port2,           rightFrontDrive, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           flail,         tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port9,           rightBackDrive, tmotorVex393_MC29, openLoop)
...
void userDrive()
{
	while(true)
	{
		...
		drive(abs(vexRT(Ch3)) > DEAD_ZONE? vexRT(Ch3): 0, abs(vexRT(Ch1)) > DEAD_ZONE? vexRT(Ch1):0, abs(vexRT(Ch4)) > DEAD_ZONE? vexRT(Ch4):0);
